...
public void draw() {
  ...
  int tl = color(clrs[0][0], clrs[0][1], clrs[0][2]);
  int tr = color(clrs[1][0], clrs[1][1], clrs[1][2]);
  int l = color(clrs[2][0], clrs[2][1], clrs[2][2]);
  int r = color(clrs[3][0], clrs[3][1], clrs[3][2]);
